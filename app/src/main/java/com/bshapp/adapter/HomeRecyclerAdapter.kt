...
import com.bshapp.R
import com.bshapp.activities.NotificationActivity
import com.bshapp.activities.ReadNewsActivity
...
class HomeRecyclerAdapter(private var list: List<HomeNewsModel>, private val context: Context) :
    ...
    override fun onBindViewHolder(holder: HomeRecyclerModel, position: Int) {
        ...
        holder.readMoreBtn.setOnClickListener {
            ...
            val id :String = list[position].newsId;
    ...
    class HomeRecyclerModel(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val readMoreBtn = itemView.findViewById<TextView>(R.id.readMoreBtn)
    }
}