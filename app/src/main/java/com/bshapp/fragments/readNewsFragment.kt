...
import com.bshapp.API.RetrofitApi
import com.bshapp.R
...
class readNewsFragment : Fragment(), DatePickerDialog.OnDateSetListener,
...
//            Toast.makeText(requireContext(),headline,Toast.LENGTH_LONG).show()
    ...
    private fun uploadToDB(
        ...
        params["date"] = date
        params["state"] = context?.let { PrefConfig.loadSelectedState(it) }
...
//
//            val modal =
//                UserUploadModel(encodedImage, headline, news, mandal, date, moreDetails, "Me")
//
//
//            val call: Call<String> = retrofitAPI.uploadNews(modal)
//            call.enqueue(object: Callback<String>{
//                override fun onResponse(call: Call<String>, response: Response<String>) {
//                    try {
//                        if (response.body() != null) Log.e("UploadResponse>>>", response.body()!!)
//
//
...
//                    Toast.makeText(requireContext(), t.message.toString(), Toast.LENGTH_LONG)
//                        .show()
//                }
//
//            })
    ...
    private fun showDialog() {
        ...
        if (dialog != null) {
            ...
            val yesBtn = dialog.findViewById(R.id.gotoHomeBtn) as Button
